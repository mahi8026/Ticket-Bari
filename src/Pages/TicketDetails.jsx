        ...
        <div className="card-body lg:w-2/3">
          ...
          <div className="mb-4">
            <h3 className="text-xl font-semibold flex items-center mb-2">
              <FaTags className="mr-2 text-secondary" /> Perks/Amenities:
            </h3>
          ...
          <div className="border-t pt-4">
            <h3 className="text-2xl font-semibold flex items-center mb-2">
              <FaCalendarAlt className="mr-2 text-accent" /> Departure Time:
            </h3>
          ...
          <div className="card-actions justify-end mt-6">
            {!user && (
              <p className="text-red-500">Please login to book tickets.</p>
            )}
            <button
